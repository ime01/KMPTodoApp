...
import kmptodoapp.composeapp.generated.resources.delete
import kmptodoapp.composeapp.generated.resources.star
...
fun TaskView(
        ...
        horizontalArrangement = Arrangement.SpaceBetween)
    {
        ...
        Row(verticalAlignment = Alignment.CenterVertically) {
            ...
            Checkbox(checked = task.completed, onCheckedChange = {onComplete(task, !task.completed)})
        ...
        IconButton(
            ...
            Icon(
                ...
                tint = if (task.favorite) MaterialTheme.colorScheme.primary else MaterialTheme.colorScheme.surface.copy(alpha = 0.38f)
            )
        }
    }
}